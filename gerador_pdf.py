...
class RelatorioLGPD(FPDF):
    def header(self):
        ...
        self.set_textcolor(26, 54, 93) # Azul Escuro
        self.cell(0, 10, "Relatório de Adequação à LGPD (MVP)", ln=True, align="C")
        self.set_font("Arial", "I", 10)
        self.set_textcolor(113, 128, 150)
...
def gerar_pdf_bytes(resultados, total_linhas):
    ...
    # Retorna o PDF gerado diretamente como bytes na memória (Privacy by Design!)
    return pdf.output()
